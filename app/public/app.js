(function() {
  ...
  var resources = {
    ...
    sounds: [
      //{ name : 'hold_the_line', value : { ogg : 'Content/music/hold_the_line.ogg', mp3 : 'Content/music/hold_the_line.mp3' }},
      {
        name: "burn_them_down",
        value: {
          ogg: "Content/music/burn_them_down.ogg",
          mp3: "Content/music/burn_them_down.mp3"
        }
      },
      {
        name: "ak47-1",
        value: {
          ogg: "Content/effects/ak47-1.ogg",
          mp3: "Content/effects/ak47-1.mp3"
        }
      },
      {
        name: "artillery",
        value: {
          ogg: "Content/effects/artillery.ogg",
          mp3: "Content/effects/artillery.mp3"
        }
      },
      {
        name: "explosion",
        value: {
          ogg: "Content/effects/explosion.ogg",
          mp3: "Content/effects/explosion.mp3"
        }
      },
      {
        name: "flak",
        value: {
          ogg: "Content/effects/flak.ogg",
          mp3: "Content/effects/flak.mp3"
        }
      },
      {
        name: "flames",
        value: {
          ogg: "Content/effects/flames.ogg",
          mp3: "Content/effects/flames.mp3"
        }
      },
      {
        name: "hellshot",
        value: {
          ogg: "Content/effects/hellshot.ogg",
          mp3: "Content/effects/hellshot.mp3"
        }
      },
      {
        name: "humm",
        value: {
          ogg: "Content/effects/humm.ogg",
          mp3: "Content/effects/humm.mp3"
        }
      },
      {
        name: "icy",
        value: {
          ogg: "Content/effects/icy.ogg",
          mp3: "Content/effects/icy.mp3"
        }
      },
      {
        name: "laser",
        value: {
          ogg: "Content/effects/laser.ogg",
          mp3: "Content/effects/laser.mp3"
        }
      },
      {
        name: "laugh",
        value: {
          ogg: "Content/effects/laugh.ogg",
          mp3: "Content/effects/laugh.mp3"
        }
      },
      {
        name: "mgnest",
        value: {
          ogg: "Content/effects/mgnest.ogg",
          mp3: "Content/effects/mgnest.mp3"
        }
      },
      {
        name: "wowpulse",
        value: {
          ogg: "Content/effects/wowpulse.ogg",
          mp3: "Content/effects/wowpulse.mp3"
        }
      }
    ]
  };
  ...
  var addUnitInfo = function(level) {
    ...
    if (level <= 10) {
      ...
      divF.innerHTML = [
        '<div class=preview><div style="background: url(',
        "Content/icons/firewizzrobe.png",
  ...
  if (visual) var logic = new GameLogic(view, maze);
  else
  ...
  if (stagePrompt == 1) {
    logic.setWaves(
      new WaveList([
        ...
        new Wave(logic, 20, [
          { unit: "Speedy", time: 1 },
          { unit: "FireWizzrobe", time: 200 },
          { unit: "Rope", time: 500 },
          { unit: "FireWizzrobe", time: 600 },
          { unit: "FireWizzrobe", time: 900 },
          { unit: "FireWizzrobe", time: 1300 },
          { unit: "DarkNut", time: 2800 }
        ]),

        new Wave(logic, 22, [
          { unit: "FireWizzrobe", time: 1 },
          { unit: "Rope", time: 600 },
          { unit: "FireWizzrobe", time: 1500 },
          { unit: "Rope", time: 2000 },
          { unit: "FireWizzrobe", time: 2800 },
        ...
        new Wave(logic, 25, [
          { unit: "DarkNut", time: 1 },
          { unit: "FireWizzrobe", time: 500 },
          { unit: "FireWizzrobe", time: 1000 },
          { unit: "FireWizzrobe", time: 1600 },
          { unit: "DarkNut", time: 2500 },
          { unit: "DarkNut", time: 3000 },
          { unit: "FireWizzrobe", time: 4000 }
        ]),

        new Wave(logic, 25, [
          { unit: "DarkNut", time: 1 },
          { unit: "FireWizzrobe", time: 600 },
          { unit: "DarkNut", time: 1000 },
          { unit: "Rope", time: 2200 },
          { unit: "FireWizzrobe", time: 4000 },
          { unit: "FireWizzrobe", time: 4900 },
      ...
      logic.setWaves(
        new WaveList([
          ...
          new Wave(logic, 22, [
            ...
            { unit: "DarkNut", time: 3000 },
            { unit: "FireWizzrobe", time: 4000 },
            { unit: "FireWizzrobe", time: 4200 }
          ]),
          new Wave(logic, 25, [
            { unit: "DarkNut", time: 1 },
            { unit: "FireWizzrobe", time: 500 },
            { unit: "FireWizzrobe", time: 1000 },
            { unit: "DarkNut", time: 1200 },
            { unit: "FireWizzrobe", time: 1600 },
            { unit: "FireWizzrobe", time: 2500 },
            { unit: "DarkNut", time: 3000 },
            { unit: "FireWizzrobe", time: 4000 },
            { unit: "DarkNut", time: 4200 }
          ]),
          new Wave(logic, 20, [
            { unit: "DarkNut", time: 1 },
            { unit: "FireWizzrobe", time: 250 },
            { unit: "FireWizzrobe", time: 600 },
            { unit: "DarkNut", time: 1000 },
            { unit: "Rope", time: 2200 },
            { unit: "Rope", time: 2300 },
            ...
            { unit: "FireWizzrobe", time: 4000 },
            { unit: "DarkNut", time: 4200 },
            { unit: "FireWizzrobe", time: 4400 },
            { unit: "Armos", time: 6000 }
          ]),
          new Wave(logic, 25, [
            { unit: "DarkNut", time: 1 },
            { unit: "DarkNut", time: 250 },
            { unit: "DarkNut", time: 600 },
            { unit: "DarkNut", time: 1000 },
            { unit: "FireWizzrobe", time: 2200 },
            { unit: "FireWizzrobe", time: 2300 },
            { unit: "Rope", time: 2400 },
            { unit: "Rope", time: 2500 },
            { unit: "FireWizzrobe", time: 2600 },
            { unit: "Armos", time: 4000 },
            { unit: "DarkNut", time: 5000 },
...
function EndGame(stage, level, hitpoints) {
  ...
  firebase
    .database()
    .ref("stages/" + stage + "/statistics/" + window.user.uid)
    .push({
