...
var sourceFiles = ['__prologue__',
	'manifest', 'oop', 'path', 'resources', 'video', 'sound', 'main', 'logic', 'units',
		'shots', 'towers', 'towerdefense', 'ai-players', 'scenarios',
			...
			app: {
				files: [
					...
					'build/<%= pkg.name %>.js',
						...
						return { nonull: true, src: f.src || f, dest: 'app/Scripts/'+ path.basename(f.dest || f) };
					})
			}
		},
		uglify: { //////////////////////////////////////////////////////////////////////////////////
...
// Register tasks. /////////////////////////////////////////////////////////////////////////////////
	grunt.registerTask('compile', [
		'concat:build_umd', 'jshint:build_umd', 'uglify:build_umd'
	]); 
